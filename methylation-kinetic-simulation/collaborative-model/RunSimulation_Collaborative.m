...
for loopchunk=1:NChunks
    ...
    for j=1:numel(Times)
        ...
        datafilename=['AllDat_'  'Simulated_Collaborative' num2str(NumCpGSites) '_Ch' num2str(loopchunk) ];
        
        for loopreads=1:NumReads
            [AllDat_each]=Collaborative_Gillespie(sites,fracmeth,TimePts,TrajFlag);
